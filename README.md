Este proyecto consiste en un explorador interactivo de personajes de la serie "Rick and Morty", desarrollado mediante HTML, CSS, Bootstrap, TypeScript y JSX. Su objetivo es proporcionar a 
